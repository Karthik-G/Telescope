...
this.route('apiPosts', {
  ...
  action: function() {
        console.log("Params is there as  "+ this.params.url );
        console.log("Params is there as  "+ this.params.userId );
        console.log("Params is there as  "+ this.params.title );
        console.log("Params is there as  "+ this.params.status );

...
this.route('apiPosts', {
  ...
  action: function() {
        ...
        console.log("title param is there as  "+ unescape(decodeURIComponent(this.params.title)) );
       ...
       var post = {
          ...
          title : unescape(decodeURIComponent(this.params.title)),
          status: this.params.status,
          body: decodeURIComponent(this.params.body)
       };
